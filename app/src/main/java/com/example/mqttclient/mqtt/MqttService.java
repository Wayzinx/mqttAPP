...
//    }
    ...
    private IMqttActionListener iMqttActionListener = new IMqttActionListener() {
        ...
        @Override
        public void onSuccess(IMqttToken arge) {
    ...
    private MqttCallback mqttCallback = new MqttCallback() {
        ...
        @Override
        public void connectionLost(Throwable argo) {
            if (mqttEventCallBack != null) {
                mqttEventCallBack.onConnectError("Connecting lost! MattService will reconnect after Ss...");
            }
